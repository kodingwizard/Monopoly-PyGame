...
def chancecardp1():
    ...
    if(((380 < player1.x < 450) and (820 < player1.y < 960)) or ((310 < player1.x < 380) and (50 < player1.y < 190)) or ((870 < player1.x < 1010) and (540 < player1.y < 610))) and (end_turn == 1) and (turn % 2 == 0):
